...
$suggestions = array(
  ...
  'plugins' => 'http://projects.karthik.sg/wpwebinstaller/list-plugin.txt' ,

 # Can be an Array of URLs for each Theme, or a string URL for a text file with URLs for each Theme on a new line
  'themes'  => 'http://projects.karthik.sg/wpwebinstaller/list-theme.txt'
...
<script src="http://projects.karthik.sg/wpwebinstaller/jquery.min.js/installer.js"></script>
